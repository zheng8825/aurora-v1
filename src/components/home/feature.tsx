        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={7}>
            ...
            <Typography sx={{ color: 'text.secondary', mb: 2, ml: { xs: 0, md: 4 } }}>
              An Energy Management System (EMS) is a technology that optimizes energy usage in buildings and facilities
              to save money and reduce environmental impact
            </Typography>

            <Grid container spacing={2} sx={{ ml: { xs: 0, md: 2 }, pr: { xs: 4, md: 0 } }}>
